...
## In the script I added a comment at the place were I added the extra code
## code changed at 2022-09-29 and renamed the script to WBVR-blat2gff.pl
...
my %matchids;
my $prefixmatch="_mid";
my $pmatch="_match_"; # add 2022-09-29
my $gffver=3;
...
my $optok= GetOptions(
  ...
  "pmatch=s", \$pmatch, # add 2022-09-29
);
...
while(<>) {
  ...
  my $matchid    = $qid .$prefixmatch. ++$matchids{$qid}.$pmatch.($qsize - $mismatches); # add 2022-09-29
